...
def main():
  ...
  print("Step 1 .....")
  table_name_bronze = "main.cjc.taxi_demo_bronze"
  ...
  table_name_silver = "main.cjc.taxi_demo_silver"
  ...
  print("Step 3 .....")
  yellow_view = "main.cjc.taxi_demo_view_yellow"
  green_view = "main.cjc.taxi_demo_view_green"
